...
static const char col_gray1[]       = "#@bg@";
static const char col_gray2[]       = "#@bg@";
static const char col_gray3[]       = "#@fg@";
static const char col_gray4[]       = "#@bg@";
static const char col_cyan[]        = "#@dwhite@";
...
static const char *MY_lockcmd[] = { "/home/sharafian/.local/bin/lock", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_l,      spawn,          {.v = MY_lockcmd } },
